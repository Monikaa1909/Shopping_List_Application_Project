...
@Entity(primaryKeys = {"idShoppingList", "idProduct"},
        foreignKeys = {
                ...
                @ForeignKey(
                        ...
                        onDelete = CASCADE)})
public class OptimizedCompositionOfTheShoppingList extends CompositionOfTheShoppingList {

    public OptimizedCompositionOfTheShoppingList() {
        super();
    }
//    public OptimizedCompositionOfTheShoppingList(@NonNull double quantity, @NonNull int idShoppingList, @NonNull int idProduct, String suggestedFormOfAccessibility) {
