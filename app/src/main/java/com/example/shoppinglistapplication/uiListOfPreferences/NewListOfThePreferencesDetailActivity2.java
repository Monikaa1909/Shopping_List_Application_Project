...
public class NewListOfThePreferencesDetailActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.element_name_without_detail);
        ...
        String dishName = getIntent().getStringExtra(CompositionListOfThePreferencesActivity.KEY_DISH_NAME);
        ...
        button.setOnClickListener(view -> {
            if (TextUtils.isEmpty(editPortions.getText())) {
                ...
                new Thread(() -> {
                    ...
                    if (!listOfPreferencesDishViewModel.listOfPreferencesDishExists(idDish, idListOfThePreferences)) {
                        ListOfPreferencesDish listOfPreferencesDish = new ListOfPreferencesDish(idListOfThePreferences, idDish, portions);
                        listOfPreferencesDishViewModel.insert(listOfPreferencesDish, emptyFunction -> {});
                        Intent intent = new Intent(NewListOfThePreferencesDetailActivity2.this, CompositionListOfThePreferencesActivity.class);
                        intent.putExtra(CompositionListOfThePreferencesActivity.KEY_LIST_OF_THE_PREFERENCES_ID, idListOfThePreferences);
                        startActivity(intent);
                        this.finish();
                    } else {
                        Intent intent = new Intent(NewListOfThePreferencesDetailActivity2.this, CompositionListOfThePreferencesActivity.class);
                        intent.putExtra(CompositionListOfThePreferencesActivity.KEY_PREFERENCES_INFO, "alreadyExists");
                        intent.putExtra(CompositionListOfThePreferencesActivity.KEY_LIST_OF_THE_PREFERENCES_ID, idListOfThePreferences);
                        startActivity(intent);
                        this.finish();
                    }
